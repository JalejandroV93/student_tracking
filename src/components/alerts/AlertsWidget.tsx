          ...
          <Table>
            ...
            <TableBody>
              {topAlerts.map((student) => (
                ...
                >
                  <TableCell className="font-medium py-2">{student.name}</TableCell>
                  <TableCell className="text-center py-2">
                    <span
                      className={`inline-flex items-center rounded-full px-2 py-0.5 text-xs font-semibold ${ // Use semibold
                  ...
                  <TableCell className="text-right py-2">{student.alertStatus?.count}</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
