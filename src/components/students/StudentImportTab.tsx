          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                ...
                <li>Debe contener exactamente estas columnas en este orden: <strong>Grado, Apellido, Nombre, Código, Id, URL de la foto</strong></li>
                <li>El campo Grado debe contener valores como: &quot;Décimo A&quot;, &quot;Kínder 5 B&quot;, &quot;Segundo A&quot;, etc.</li>
            ...
            <div className="space-y-2">
              ...
              <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                <li>Si un estudiante ya existe (mismo código), se actualizará su información</li>
                <li>Si un estudiante no existe, se creará uno nuevo</li>
                <li>Se asigna automáticamente el nivel académico basado en el grado</li>
                <li>Los estudiantes se asocian al año académico seleccionado</li>
              </ul>
            </div>
          </CardContent>
        </Card>
